...
namespace TLMemory
{
	// Tootle wrapper for the Loki small object allocator class
	class TSmallObjectAllocator : public Loki::SmallObjAllocator
	{
	public:
		TSmallObjectAllocator(std::size_t pageSize, std::size_t maxObjectSize, std::size_t objectAlignSize ) :

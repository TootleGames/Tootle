/*
 *  TSmallObjectAllocator.cpp
 *  TootleCore
 *
 *  Created by Duane Bradbury on 12/05/2009.
 *  Copyright 2009 Tootle. All rights reserved.
 *
 *	The small object allocator is essentially a copy of the LOKI SOA with minor changes to naming
 *	to fit within the Tootle system.  Also the SmallObj class has been changed to not utilise the LOKI singleton class and
 *	instead is routed through our memory manager.
 *
 */

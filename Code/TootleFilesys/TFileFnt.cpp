...
//	import the XML
//--------------------------------------------------------
SyncBool TLFileSys::TFileFnt::ExportAsset(TPtr<TLAsset::TAsset>& pAsset,Bool& Supported)
{
	if ( pAsset )
	{
...
<font>
  ...
  <chars count="91">
	...
	*/
	...
	TLFileSys::TFileRef FileRef = TLFileSys::GetFileRef( *pPageTextureFileString, TRef() );
	Atlas.SetTextureRef( FileRef.GetFileRef() );

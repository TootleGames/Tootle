...
public:
	...
	virtual TPtr<TFile>		CreateFile(const TString& Filename);	//	create a new empty file into file system if possible - if the filesys is read-only we cannot add external files and this fails
};

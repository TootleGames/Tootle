...
public:
	TScreen(const TRef& ScreenRef=TRef());
	~TScreen();
	...
	inline Bool				GetRenderTargetSize(Type4<s32>& Size,TRefRef TargetRef) {	return GetRenderTargetSize( Size, GetRenderTarget( TargetRef ) );	}

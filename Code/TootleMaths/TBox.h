...
namespace TLMaths
{
	...
	class TBoxOB;	//	3D orientated box - this is a cube (though perhaps not square). 8 points in space
	class TBoxOB2D;	//	2D orientated box - this is essentially just a quad. 4 points in space

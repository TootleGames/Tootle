...
void ftglError(GLenum errCode, TLMaths::TGlutTessellator* pTessellator);
void ftglVertex(void* data, TLMaths::TGlutTessellator* pTessellator);
void ftglCombine(GLdouble coords[3], void* vertex_data[4], GLfloat weight[4], void** outData, TLMaths::TGlutTessellator* pTessellator);
void ftglBegin(GLenum type, TLMaths::TGlutTessellator* pTessellator);
void ftglEnd(TLMaths::TGlutTessellator* pTessellator);
void ftglEdgeFlag(GLboolean EdgeFlag,TLMaths::TGlutTessellator* pTessellator);

...
+ (void)setGameIsFavorite:(NSString*)clientApplicationId favorite:(bool)favorite review:(NSString*)review onSuccess:(const OFDelegate&)onSuccess onFailure:(const OFDelegate&)onFailure
{
...
+ (void) makeGameFavorite:(NSString*)clientApplicationId reviewText:(NSString*)review onSuccess:(const OFDelegate&)onSuccess onFailure:(const OFDelegate&)onFailure
{
	[OFClientApplicationService setGameIsFavorite:clientApplicationId favorite:true review:review onSuccess:onSuccess onFailure:onFailure];
}

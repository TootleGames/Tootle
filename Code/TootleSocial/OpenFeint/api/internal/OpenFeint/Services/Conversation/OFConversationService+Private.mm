...
+ (void)deleteConversation:(NSString*)conversationId onSuccess:(OFDelegate const&)success onFailure:(OFDelegate const&)failure {
	OFPointer<OFHttpNestedQueryStringWriter> params = new OFHttpNestedQueryStringWriter;
    params->io("client_application_id", [OpenFeint clientApplicationId]);

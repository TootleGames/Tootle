...
OFSettings::OFSettings()
{
	...
	mMultiplayerServerUrl = @"http://mp.openfeint.com";
#else
	mMultiplayerServerUrl = @"http://mp-sandbox.openfeint.com";
#endif
    ...
    mDebugOverrideKey = nil;
    mDebugOverrideSecret = nil;
...
void OFSettings::loadSettingsFile()
{
	...
	OFSettingsReader.io("multiplayer-server-url", mMultiplayerServerUrl);
    ...
    OFSettingsReader.io("debug-override-key", mDebugOverrideKey);
    OFSettingsReader.io("debug-override-secret", mDebugOverrideSecret);

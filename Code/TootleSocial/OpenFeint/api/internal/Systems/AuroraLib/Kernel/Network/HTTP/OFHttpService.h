...
public:
	...
	virtual void startRequest(NSString* path, NSString* httpMethod, NSData* httpBody, NSString* email, NSString* password, NSObject* userData, NSString* multiPartBoundary, OFHttpServiceObserver* requestSpecificObserver);

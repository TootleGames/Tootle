...
public:
	...
	NSString* getMultiplayerServerUrl() const			{ return mMultiplayerServerUrl; }
	...
	NSString* getDebugOverrideKey() const              { return mDebugOverrideKey; }
    NSString* getDebugOverrideSecret() const            { return mDebugOverrideSecret; }
...
private:
	...
	OFRetainedPtr<NSString> mMultiplayerServerUrl;
	...
	OFRetainedPtr<NSString> mDebugOverrideKey;
	OFRetainedPtr<NSString> mDebugOverrideSecret;
};

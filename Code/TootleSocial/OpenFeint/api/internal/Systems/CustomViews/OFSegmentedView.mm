...
//	self.activeShadowColor = [UIColor colorWithWhite:98.f/255.f alpha:0.5f];
    ...
    barFrame.size.height = [OFSegmentedView segmentedViewHeight];
    self.frame = barFrame;
    
    NSString *imgSuffix = [OpenFeint isLargeScreen] ? @"IPad" : @"";
	self.inactiveItemBackgroundImage = [[OFImageLoader loadImage:[NSString stringWithFormat:@"OFTabBarOverlappingSegment%@.png",       imgSuffix]] stretchableImageWithLeftCapWidth:27 topCapHeight:0];
	self.activeItemBackgroundImage   = [[OFImageLoader loadImage:[NSString stringWithFormat:@"OFTabBarOverlappingSegmentActive%@.png", imgSuffix]] stretchableImageWithLeftCapWidth:27 topCapHeight:0];

...
{
	@package
	OFUser* senderUser;						// <sender>
	OFUser* receiverUser;					// <receiver>
	...
	NSString* userMessage;					// <user_message>
...
@property (nonatomic, retain) OFUser* senderUser;
@property (nonatomic, retain) OFUser* receiverUser;

...
public:
	...
	OFHighScoreBatchEntry(NSString* _leaderboardId, int64_t _score, NSString* _displayText = nil, NSString* _customData = nil, NSData* _blob = nil);

...
********************************************************************************
**** What's New? (Version 2.4.10, 6.10.2010) 
********************************************************************************
- Fixes for iOS4 compatibility.

********************************************************************************
**** Integration Changes (Version 2.4.10, 6.10.2010)
********************************************************************************
- None
...
1. Ensure you have XCode version 3.2
2. Ensure you are building with Base SDK of 3.0 or newer. You may still use a Deployment Target as low as 2.0.
...
7. Remove unused asset folders. This is not a necessary step but helps cut down the application size. You need to do this every time you download a new OpenFeint project.
		* If your game is landscape only or iPad only delete the iPhone_Landscape folder
		* If your game is portrait only or iPad only delete the iPhone_Portrait folder
...
10. If you have set your 'iPhoneOS Deployment Target' to any version before 3.0 you must weak link some libraries.
...
11. You must have a prefix header. It must have the following line: #import "OpenFeintPrefix.pch"
12. You must be compiling with Objective-C++ (Use a .mm file extension, rather than .m)

...
@property (nonatomic, readonly) NSUInteger userAchievements;
@property (nonatomic, readonly) NSUInteger totalAchievements;
@property (nonatomic, readonly, retain) NSMutableArray* userGameStats;

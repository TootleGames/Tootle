...
void OFResourceDataMap::addField(NSString* name, SEL setter)
{
...
void OFResourceDataMap::addNestedResourceField(NSString* name, SEL setter, Class resourceClass)
{
	FieldDescription desc;
	desc.setter = setter;
	desc.dataFieldName = name;
...
void OFResourceDataMap::addNestedResourceArrayField(NSString* name, SEL setter)
{
	FieldDescription desc;
	desc.setter = setter;
	desc.dataFieldName = name;
